...
<section>
    <div class="row font-custom-awl-14" style="padding: 10px 20px; font-weight: bold;">
        ...
        <div class="col-3">
            <div class="row d-flex align-items-center">
                <label for="" class="col-4 col-form-label">ผู้ติดต่อ</label>
                <div class="col-8">
        ...
        <div class="col-2 d-flex align-items-center"><font style="font-size: 12px; color:red;">*หมายเหตุ : หากแก้ไขข้อมูลลูกค้า ข้อมูลจะถูก Save ทับข้อมูลเดิมในฐานอัตโนมัติ</font></div>
...
<section>
    <div class="row font-custom-awl-14" style="padding: 0px 20px; font-weight: bold;">
        ...
        <div class="col-3">&nbsp;</div>
        <div class="col-12"><textarea class="form-control" name="" id="" rows="2"></textarea></div>
    </div>
</section>

<hr style="margin: 40px 0px;">

<section class="font-custom-awl-14" style="font-weight:bold;">
    <div style="background-color: #FAFAFA; height: 45px; display: flex; align-items: center; padding:0px 20px; margin: 0px 0px 20px 0px;">
        <input type="checkbox" name="11" id="11"> &nbsp; &nbsp; <label for="11">ประมาณการขาย</label>
    </div>
    <div style="background-color: #FAFAFA; height: 45px; display: flex; align-items: center; padding:0px 20px; margin: 0px 0px 20px 0px;">
        <input type="checkbox" name="22" id="22"> &nbsp; &nbsp; <label for="22">Demo ทดลองสินค้า</label>
    </div>
    <div style="background-color: #FAFAFA; height: 45px; display: flex; align-items: center; padding:0px 20px; margin: 0px 0px 20px 0px;">
        <input type="checkbox" name="33" id="33"> &nbsp; &nbsp; <label for="33">ออกบูธ (Group Presentation)</label>
    </div>
    <div style="background-color: #FAFAFA; height: 45px; display: flex; align-items: center; padding:0px 20px; margin: 0px 0px 20px 0px;">
        <input type="checkbox" name="44" id="44"> &nbsp; &nbsp; <label for="44">ข้อมูลคู่เเข่ง</label>
    </div>
</section>

<a href=""><span class="badge rounded-pill" style="background-color: #F1E1FF; color:#525252; padding-left: 15px; padding-right: 15px;"><img src="assets/images/icon_system/link-alt-regular-24.png" style="width:15px; height:15px; color:#FFFFFF;"> แบบฟอร์มข้อร้องเรียน</span></a>
