...
?>
<center>
    <h3>รายงานสรุปการประมาณการขายตามเปอร์เซ็นต์</h3>
</center>
...
<table class="table-thead-custom-awl table-bordered border-secondary" style="width: 100%; font-size:14px;" >
    <tr>
        <th width="8%" align="center" bgcolor="#ebe4ed">วันที่ตั้งเรื่อง</th>
        <th width="8%" align="center" bgcolor="#ebe4ed">วันที่จะได้รับ PO</th>
        <th width="15%" align="center" bgcolor="#ebe4ed">โรงพยาบาล</th>
        <th width="13%" align="center" bgcolor="#ebe4ed">หน่วยงาน</th>
        <th width="20%" align="center" bgcolor="#ebe4ed">รายการ</th>
        <th width="8%" align="center" bgcolor="#ebe4ed">จำนวน</th>
        <th width="5%" align="center" bgcolor="#ebe4ed">มูลค่า</th>
        <th width="5%" align="center" bgcolor="#ebe4ed">เปอร์เซ็น</th>
        <th width="15%" align="center" bgcolor="#ebe4ed">วันที่คาดว่าจะส่งสินค้า</th>
        <th width="15%" align="center" bgcolor="#ebe4ed">เขตการขาย</th>
    </tr>
    <?php

    if ($_SESSION['em_id'] == 'SS1') {
        $sddd = "   and sale_area !='S11'  and sale_area !='S12' and sale_area !='S13'  and sale_area !='S17'  and sale_area !='S23'  and sale_area !='S24'  and sale_area !='S31' and sale_area !='SM1' and sale_area !='MM1' and sale_area !='S32' and head_area ='SS1'";
    } else if ($_SESSION['em_id'] == 'SS2') {
        $sddd = "  and sale_area !='S14'  and sale_area !='S15' and sale_area !='S16'  and sale_area !='S21'  and sale_area !='S22'  and sale_area !='S31' and sale_area !='S32' and sale_area !='SM1' and sale_area !='MM1' and head_area ='SS2'";
    } else if ($_SESSION['em_id'] == 'SS3') {
        $sddd = "  and sale_area !='S14'  and sale_area !='S15' and sale_area !='S16'  and sale_area !='S21'  and sale_area !='S22'  and sale_area !='S11'  and sale_area !='S12' and sale_area !='S13'  and sale_area !='S17'  and sale_area !='S23'  and sale_area !='S24' and head_area ='SS3'";
    }
    ...
    ?>
        <tr>
            ...
            <td align="right"> <?php if ($objResult["unit_product1"] != '0') {
                                    echo $objResult["unit_product1"];
                                } ?>&nbsp;<?php echo $objResult["unit_name1"]; ?></td>
            <td align="right"><?php $sum_price_product = $objResult["sum_price_product"];
