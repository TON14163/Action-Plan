<div class="accordion-item rounded-0 border border-0">
    ...
    <div id="panelsStayOpen-collapse1" class="accordion-collapse collapse">
        <div class="accordion-body">
            <!--  -->
            <?php
            $strSQLne = "SELECT * FROM tb_register_data WHERE id_customer = '".$show->showDetails($id_work,'id_customer')."' AND summary_order = '0' AND summary_product1 != '' ORDER BY percent_id ASC , date_request ASC ";
                ...
                <table class="table-thead-custom-awl table-bordered border-secondary">
                    ...
                    while($objResultne = mysqli_fetch_array($objQueryne)) { ?>
                        <tr>
                            ...
                            <td><a href="report_quotation_edit?id_work=<?php echo $show->showDetails($id_work,'id_work');?>&id_customer=<?php echo $show->showDetails($id_work,'id_customer');?>"><img src="assets/images/icon_system/edit.png" style="width: 20px; height: 20px;"></a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
